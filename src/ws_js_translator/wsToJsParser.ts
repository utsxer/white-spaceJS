import {Push,Dup,Copy,Swap,Discard,Slide,Add,Sub,Mul,Div,Mod,Store,Retrieve,Mark,Call,Jmp,Jmpz,Jmpn,Ends,End,ReadChar,ReadNum,PutChar,PutNum} from 'ws_js_translator/parserClasses'
...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c0 = function(imp: any): any {return imp;};
  ...
  const peg$c3 = function(): any {return new Dup()};
  const peg$c4 = function(copyNumber: any): any {return new Copy(copyNumber)};
  const peg$c5 = function(): any {return new Swap()};
  const peg$c6 = function(): any {return new Discard()};
  const peg$c7 = function(slideNumber: any): any {return new Slide(slideNumber)};
  const peg$c8 = function(arithValue: any): any {return arithValue;};
  const peg$c9 = function(): any {return new Add();};
  const peg$c10 = function(): any {return new Sub();};
  const peg$c11 = function(): any {return new Mul();};
  const peg$c12 = function(): any {return new Div();};
  const peg$c13 = function(): any {return new Mod();};
  const peg$c14 = function(heapValue: any): any {return heapValue;};
  const peg$c15 = function(): any {return new Store();};
  const peg$c16 = function(): any {return new Retrieve();};
  const peg$c17 = function(flowValue: any): any {return flowValue};
  const peg$c18 = function(markLabel: any): any {return new Mark(markLabel)};
  const peg$c19 = function(callLabel: any): any {return new Call(callLabel)};
  const peg$c20 = function(jumpLabel: any): any {return new Jmp(jumpLabel)};
  const peg$c21 = function(jumpzLabel: any): any {return new Jmpz(jumpzLabel)};
  const peg$c22 = function(jumpnLabel: any): any {return new Jmpn(jumpnLabel)};
  const peg$c23 = function(): any {return new Ends()};
  const peg$c24 = function(): any {return new End()};
  const peg$c25 = function(ioVal: any): any {return ioVal};
  const peg$c26 = function(): any {return new PutChar()};
  const peg$c27 = function(): any {return new PutNum()};
  const peg$c28 = function(): any {return new ReadChar()};
  const peg$c29 = function(): any {return new ReadNum()};
